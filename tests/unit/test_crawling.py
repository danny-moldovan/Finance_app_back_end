    ...
    def test_perform_crawling_success(self):
        ...
        recent_news = GenerateRecentNews(
            ...
            retrieved_urls=["https://www.bostonglobe.com/2025/04/02/nation/trump-tariffs-economy/", #Can be parsed using requests
                "https://seekingalpha.com/article/4772743-the-art-of-trump-trade-deal", #Can be parsed using requests
                ...
                "https://www.reuters.com/markets/us/global-markets-view-usa-2025-04-03/"] #Can be parsed using Crawlbase
        )
        ...
        self.assertEqual(len(result.parsed_urls), 4)
        
        # Check all URLs except the last one
        for url in recent_news.retrieved_urls[:-1]:
